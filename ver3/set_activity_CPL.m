...
% 最大值置为1，其余为0
weight_recurrent_CPL=weight_recurrent_CPL';
input_CPL_rand = input_CPL(weight_recurrent_CPL);
n_cluster = numNeurons_CPL/numNeurons_cluster;
input_cpl_group = reshape(input_CPL_rand,numNeurons_cluster,n_cluster);
...
output_CPL(weight_recurrent_CPL(max_index))=1;
% 最大值置为1，其余为0
