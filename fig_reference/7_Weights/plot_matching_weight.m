...
[syn_A_begin_list, syn_B_begin_list, syn_A_end_list, syn_B_end_list] = matching();
...
plot([mean_syn_A_begin, mean_syn_A_begin], [0, 150], 'r--');
hold off;
set(gca,'XTick',[-0.02:0.02:0.12]','XTickLabel',num2str([-0.02:0.02:0.12]'), 'YLim', [0 150], 'YTick',[0:50:150]');
...
plot([mean_syn_B_begin, mean_syn_B_begin], [0, 150], 'r--');
hold off;
set(gca,'XTick',[-0.02:0.02:0.12]','XTickLabel',num2str([-0.02:0.02:0.12]'), 'YLim', [0 150], 'YTick',[0:50:150]');
...
plot([mean_syn_A_end, mean_syn_A_end], [0, 250], 'r--');
hold off;
set(gca,'XTick',[-0.02:0.02:0.12]','XTickLabel',num2str([-0.02:0.02:0.12]'), 'YLim', [0 250], 'YTick',[0:50:250]');
ylabel('Number of Weights', 'FontSize', 14);
...
plot([mean_syn_B_end, mean_syn_B_end], [0, 250], 'r--');
hold off;
set(gca,'XTick',[-0.02:0.02:0.12]','XTickLabel',num2str([-0.02:0.02:0.12]'), 'YLim', [0 250], 'YTick',[0:50:250]');
xlabel('Weights', 'FontSize', 14);
...
print(gcf, '-depsc2', 'Weights_matching_Change.eps');
