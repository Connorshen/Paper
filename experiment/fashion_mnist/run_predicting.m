...
for i=1:n_batch
    ...
    %forward
    [input_cpl,output_cpl,b_reward,b_digit_category,~,~,b_predict_prob_all]=forward(net,init_para,batch_img,batch_label);
    ...
    output_cpl_all = [output_cpl_all;output_cpl'];
...
predict_result.output_cpl = output_cpl_all;
