function [check_points,best_train_result] = inhibition_trainer(init_para,net,data,train_early_stopping,test_early_stopping)
...
for i=1:epoch
    for j=1:train_len
        ...
        [~,output_cpl,b_reward,~,b_predict_prob,b_predict,~]=inhibition_forward(net,init_para,batch_img,batch_label);
        %backward
...
init_para.trainer = "inhibition_trainer";
